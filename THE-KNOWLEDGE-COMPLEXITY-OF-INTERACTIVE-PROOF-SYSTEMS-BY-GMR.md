...
>
> 回顾我们之前的注解，也就是我们对零知识性的定义的一个合理预期。在那里，我们把 $x$ 当作一个随机变量，然后希望条件随机变量 $s_x$ 和 $s'_x$ 是同分布的，如果强调其随机性来源都是 $bits_x, bits_A, bits_B$ 的话，我们知道 $s_x$ 和 $s'_x$ 在随机比特遍历的情况下，其取值的多重集合是相同的。这就和这里的 **统计不可区分** 的极端情况，也就是 **相等的** 的概率，完全一致了。
>
