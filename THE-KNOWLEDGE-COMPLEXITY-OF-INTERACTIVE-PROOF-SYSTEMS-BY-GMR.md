...
### 例子3.3
>（12）类似例子3.1，但是我们允许A使用随机带上的随机比特。出于简单考虑，我们假设B不适用随机带。设定交互协议如下：1. B发送"hello"; 2. A选择一个 $`r \in \{0,1\}`$ ，并发送 $x+r \mod 2$ 给B; 3. B结束交互。
